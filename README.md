...
1. node_modules/react-native-picker/android/src/main/java/com/beefe/picker/PickerViewModule.java
...
2. node_modules/react-native-picker/ios/RCTBEEPickerManager/BzwPicker.m

注释掉 self.pick.hidden=YES;

```
// self.pick.hidden=YES;
```

3. /node_modules/react-native-picker/ios/RCTBEEPickerManager/RCTBEEPickerManager.m
