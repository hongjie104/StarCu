...
// 保存理货信息
export function updateTally(missionId, beforeTally, beforeTallyLeft, atferTally, atferTallyLeft, skuDataJson) {
	return post(`${SERVER_HOST}/ShareWork/app/tally/save`, {
		token: global.token,
		taskId: missionId,
